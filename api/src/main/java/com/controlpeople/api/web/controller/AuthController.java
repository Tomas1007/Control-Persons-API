...
import com.controlpeople.api.Dto.AuthenticationRequest;
import com.controlpeople.api.Dto.AuthenticationResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createToken(@RequestBody AuthenticationRequest request){
        try {
            ...
            UserDetails userDetails = personUserDetailsService.loadUserByUsername(request.getUsername());
